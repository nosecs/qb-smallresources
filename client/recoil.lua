local recoils = {
	...
	-- Handguns
	[453432689] = 0.8,			--['weapon_pistol']
	[-1075685676] = 0.8,		--['weapon_pistol_mk2']
	[1593441988] = 0.6,			--['weapon_combatpistol']
	[584646201] = 0.6,			--['weapon_appistol']
	[911657153] = 0.1,			--['weapon_stungun']
	[-1716589765] = 1.2,		--['weapon_pistol50']
	[-1076751822] = 0.4,		--['weapon_snspistol']
	[-771403250] = 1.2,			--['weapon_heavypistol']
	[137902532] = 0.8,			--['weapon_vintagepistol']
	[1198879012] = 0.5,			--['weapon_flaregun']
	[-598887786] = 1.8,			--['weapon_marksmanpistol']
	[-1045183535] = 1.4,		--['weapon_revolver']
	[-879347409] = 1.4,			--['weapon_revolver_mk2']
	[-1746263880] = 1.2,		--['weapon_doubleaction']
	[-2009644972] = 0.4,		--['weapon_snspistol_mk2']
	[-1355376991] = 0.4,		--['weapon_raypistol']
	[727643628] = 0.8,			--['weapon_ceramicpistol']
	[-1853920116] = 1.2,		--['weapon_navyrevolver']
	[1470379660] = 1.6,			--['weapon_gadgetpistol']

	-- Submachine Guns
	[324215364] = 0.8,			--['weapon_microsmg']
	[736523883] = 0.6,			--['weapon_smg']
	[2024373456] = 0.6,			--['weapon_smg_mk2']
	[-270015777] = 0.8,			--['weapon_assaultsmg']
	[171789620] = 0.8,			--['weapon_combatpdw']
	[-619010992] = 1.2,			--['weapon_machinepistol']
	[-1121678507] = 0.4,		--['weapon_minismg']
	[1198256469] = 0.8,			--['weapon_raycarbine']

	-- Shotguns
	[487013001] = 0.5,			--['weapon_pumpshotgun']
	[2017895192] = 0.8,			--['weapon_sawnoffshotgun']
	[-494615257] = 0.6,			--['weapon_assaultshotgun']
	[-1654528753] = 0.6,		--['weapon_bullpupshotgun']
	[-1466123874] = 1.4,		--['weapon_musket']
	[984333226] = 0.6,			--['weapon_heavyshotgun']
	[-275439685] = 0.6,			--['weapon_dbshotgun']
	[317205821] = 0.6,			--['weapon_autoshotgun']
	[1432025498] = 0.5,			--['weapon_pumpshotgun_mk2']
	[94989220] = 0.6,			--['weapon_combatshotgun']

	-- Assault Rifles
	[-1074790547] = 0.6,		--['weapon_assaultrifle']
	[961495388] = 0.6,			--['weapon_assaultrifle_mk2']
	[-2084633992] = 0.6,		--['weapon_carbinerifle']
	[-86904375] = 0.6,			--['weapon_carbinerifle_mk2']
	[-1357824103] = 0.8,		--['weapon_advancedrifle']
	[-1063057011] = 0.8,		--['weapon_specialcarbine']
	[2132975508] = 0.6,			--['weapon_bullpuprifle']
	[1649403952] = 0.6,			--['weapon_compactrifle']
	[-1768145561] = 0.8,		--['weapon_specialcarbine_mk2']
	[-2066285827] = 0.6,		--['weapon_bullpuprifle_mk2']
	[-1658906650] = 0.6,		--['weapon_militaryrifle']

	-- Light Machine Guns
	[-1660422300] = 0.1,		--['weapon_mg']
	[2144741730] = 0.1,			--['weapon_combatmg']
	[1627465347] = 0.2,			--['weapon_gusenberg']
	[-608341376] = 0.1,			--['weapon_combatmg_mk2']

	-- Sniper Rifles
	[100416529] = 0.2,			--['weapon_sniperrifle']
	[205991906] = 0.3,			--['weapon_heavysniper']
	[-952879014] = 0.1,			--['weapon_marksmanrifle']
	[856002082] = 1.2,			--['weapon_remotesniper']
	[177293209] = 0.3,			--['weapon_heavysniper_mk2']
